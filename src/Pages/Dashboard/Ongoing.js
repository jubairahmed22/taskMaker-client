...
const Ongoing = ({ workDetails }) => {
  ...
  const fetchNewTask = async () => {
    try {
      const response = await fetch("https://server-tawny-tau.vercel.app/taskOngoingData");
                ...
                <div className=" flex flex-row justify-between rounded px-5 py-2 mt-2">
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <button
                        className="bg-green-600 hover:bg-green-700 text-white font-roboto px-2 py-1 rounded-lg "
